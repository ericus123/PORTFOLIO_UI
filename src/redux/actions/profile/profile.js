...
export const changePassword = () => async (dispatch) => {
  ...
  export const completeProfile = (Occupation, Gender, Image, Bio) => async (dispatch) => {
  try {
...
export const updateProfile = (FirstName, LastName, Username, Occupation, Gender, Bio) => async (dispatch) => {
    try {
